...
- 目标管理与日程联动；全文 + 语义混合检索
- 通过 Microsoft Graph 读写 Exchange / Outlook 日历；首次连接前按[迁移计划 §1](docs/plans/2026-07-16-schedule-migration.md#1-用户侧前置条件实施不阻塞真实登录前需要)完成 Entra 应用注册
- 除 Outlook 日程外的业务与记忆数据存本地 SQLite，向量索引可随时重建
