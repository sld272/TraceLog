...
- SQLite 表：`user_md_revisions` / `soul_memory_revisions` / legacy `pending_user_md_changes`。
...
| user.md 旧版待审核 AI 变更 | `state.db` pending_user_md_changes 表 | ✗ | 遗留兼容表；新流程不再写入 |
